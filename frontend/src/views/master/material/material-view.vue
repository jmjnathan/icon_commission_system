...
import { useMasterMaterial, type MasterMaterial } from "../../../composables/master/m_material.ts";
...
function openEditModal(item: MasterMaterial) {
...
async function handleDelete(item: MasterMaterial) {
  const confirmed = await confirm({
    title: "Hapus Bahan",
    message: `Yakin ingin menghapus bahan "${item.name}"? Tindakan ini tidak dapat dibatalkan.`,
...
function buildMenuItems(item: MasterMaterial) {
  return [
    {
      label: "Edit",
      icon: Pencil,
