    ...
    <button
      ...
      <div class="flex items-center gap-1 shrink-0">
        <Loader2
          v-if="loading"
          :size="14"
          class="animate-spin text-[#8A7A5C]" />
        <button
        ...
        <ChevronDown
          :size="16"
          class="text-[#8A7A5C] transition-transform"
    ...
    <div
      ...
      <div class="p-2 border-b border-[#E5D9BF]">
        <div class="relative">
          <Search
            :size="14"
            class="absolute left-3 top-1/2 -translate-y-1/2 text-[#B0A588]" />
          <input
            v-model="search"
            type="text"
            placeholder="Cari..."
      ...
      <div class="max-h-56 overflow-y-auto">
        <p
          ...
          class="px-4 py-3 text-sm text-[#8A7A5C]">
          Tidak ditemukan.
        </p>
        <button
          ...
          :class="
            option.value === modelValue ? 'bg-[#C9A24B]/10 font-medium' : ''
          ">
          {{ option.label }}
        </button>
      </div>
